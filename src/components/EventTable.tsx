...
export default function ColumnGroupingTable() {
    ...
    return (
        <Paper sx={{
            ...
            <Stack mb={2} direction={{xs:"column", lg:'row'}} justifyContent={"space-between"} alignItems={"center"} spacing={2}>
            <Stack mb={2} p={2} direction={{xs:"column", md:'row'}} alignItems={"center"} spacing={2}>
                <Paper
                    component="form"
                    sx={{ background: themes === 'AlphaTwelve' ? "#F1F5F9" as string  : "#6A6676", height: "40px",border: themes === 'AlphaTwelve' ? `2px solid #E2E8F0` : "none", borderRadius: "5px", p: '2px 4px', display: 'flex', alignItems: 'center', width: "auto" }}
                >
                ...
                <FormControl  size={'small'} sx={{background: themes === 'AlphaTwelve' ? "#F1F5F9" as string  : "#6A6676", borderRadius:"5px", width:"90px"}} >
                ...
                <FormControl  size={'small'} sx={{color: themes === 'AlphaTwelve' ? theme.palette.info as unknown as string  : theme.palette.common.white as string, background: themes === 'AlphaTwelve' ? "#F1F5F9" as string  : "#6A6676", borderRadius:"5px", width:"90px"}} >
               ...
               <Stack p={2} direction={{xs:"column", md:'row'}} alignItems={"center"} spacing={2}>
                   ...
                   <Button
                       ...
                       variant="outlined"
                       tabIndex={-1}
                       style={{background: themes === 'AlphaTwelve' ? "#F1F5F9" as string  : "#6A6676", border: `1px solid ${theme.colors.primaryAlt}`, padding: ".5rem 2rem !important", borderRadius: "5px", color: themes === 'AlphaTwelve' ? "#6A6676" as unknown as string  : theme.palette.common.white as string,}}
